...
<head>
	...
	<?php 
		...
		include 'link.php';
		$sql = "SELECT * FROM payment WHERE pay_type LIKE 'bank' ";
	...
	<div class="container-fluid text-center bg-light" style="height: 90vh">
          ...
          <div class="section row ml-sm-1 mr-sm-1" style="height: 70vh">
            ...
            <div class="col-sm-9" id="col2">
			    <table class="table table-striped d-block container">
					<thead>
						<tr>
							<th>Receipt Id</th>
							<th>Full Name</th>
							...
							<tr>
								...
								<td>
									<button class="btn btn-warning">
										<a href="e_bank.php?id=<?php echo $result['receiptId'] ?>">edit</a>
									</button>
								</td>
								<td>
									<button class="btn btn-danger">
										<a href="bank.php?id=<?php echo $result['receiptId'] ?>" onclick="return confirm('are you sure? you want to delete <?php echo $result['fullName'] ?>')">delete</a>
									</button>
								</td>
							</tr>
						<?php endforeach ?>
