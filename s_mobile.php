...
<head>
	...
	<?php 
		...
		include 'link.php';
		$sql = "SELECT * FROM payment WHERE pay_type LIKE 'mobile'";
							...
							<tr>
								...
								<td>
									<button class="btn btn-warning">
										<a href="e_mobile.php?id=<?php echo $result['receiptId'] ?>">edit</a>
									</button>
								</td>
								<td>
									<button class="btn btn-danger">
										<a href="mobile.php?id=<?php echo $result['receiptId'] ?>" onclick="return confirm('are you sure? you want to delete <?php echo $result['fullName'] ?>')">delete</a>
									</button>
								</td>
							</tr>
						<?php endforeach ?>
